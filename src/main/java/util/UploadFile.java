...
public class UploadFile {
	// MERITO DO JOAO PW 2º ANO CEFET-MG 2021 TE AMAMOS
	...
	public boolean doUploadParameter(HttpServletRequest request, ServletContext context, String parameterName, String user) {
