					...
					<div class="row g-3">
						...
						<div class="col-8">
							...
							<input type="text" class="form-control"
								...
								class="form-control" value="${autonomo.cpf}" name="cpf" id="cpf" pattern=".{14,14}" required>
							<label class="form-label">Telefone</label><input type="text"
								class="form-control" value="${autonomo.tel}" name="tel" id="telefone" pattern=".{16,16}" required>
