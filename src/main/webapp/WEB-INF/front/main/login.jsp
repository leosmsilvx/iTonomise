...
<body class="text-center">
	...
	<main class="form-signin w-100 m-auto">
			...
			<form action="controller?action=confirmarLogin" method="post">
				...
				<div class="input-group py-1">
					<input type="password" class="form-control form-control-lg" name="senha" id="senha"
						...
						<button class="btn btn-outline-secondary" type="button" onclick="mostrarSenha()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-slash" viewBox="0 0 16 16">
			...
			<a href="controller?action=index" class="nav-link text-muted">Não é usuário? Se cadastre agora!</a>
